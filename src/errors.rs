...
pub const ABSTRACT_WITH_BODY: Diagnostic = Diagnostic::new(1245, "Method '{0}' cannot have an implementation because it is marked abstract.");
...
pub const NO_EXPORTED_MEMBER: Diagnostic = Diagnostic::new(2305, "Module '{0}' has no exported member '{1}'.");
pub const CANNOT_FIND_MODULE: Diagnostic = Diagnostic::new(2307, "Cannot find module '{0}' or its corresponding type declarations.");
pub const NO_DEFAULT_EXPORT: Diagnostic = Diagnostic::new(2308, "Module '{0}' has no default export.");
pub const CIRCULAR_BASE_TYPE: Diagnostic = Diagnostic::new(2310, "Type '{0}' recursively references itself as a base type.");
pub const EXTENDS_NON_CLASS: Diagnostic = Diagnostic::new(2311, "A class may only extend another class.");
pub const IMPLEMENTS_NON_CLASS: Diagnostic = Diagnostic::new(2312, "A class may only implement another class or interface.");
pub const CIRCULAR_CONSTRAINT: Diagnostic = Diagnostic::new(2313, "Type parameter '{0}' has a circular constraint.");
pub const GENERIC_ARITY: Diagnostic = Diagnostic::new(2314, "Generic type '{0}' requires {1} type argument(s).");
...
pub const NOT_ASSIGNABLE: Diagnostic = Diagnostic::new(2322, "Type '{0}' is not assignable to type '{1}'.");
pub const PROPERTY_NOT_EXIST: Diagnostic = Diagnostic::new(2339, "Property '{0}' does not exist on type '{1}'.");
pub const PRIVATE_PROPERTY: Diagnostic = Diagnostic::new(2341, "Property '{0}' is private and only accessible within class '{1}'.");
pub const CONSTRAINT_NOT_SATISFIED: Diagnostic = Diagnostic::new(2344, "Type '{0}' does not satisfy the constraint '{1}'.");
pub const ARG_NOT_ASSIGNABLE: Diagnostic = Diagnostic::new(2345, "Argument of type '{0}' is not assignable to parameter of type '{1}'.");
...
pub const MISSING_RETURN: Diagnostic = Diagnostic::new(2366, "Function lacks ending return statement and return type does not include 'undefined'.");
pub const SUPER_BEFORE_THIS: Diagnostic = Diagnostic::new(2376, "'super' must be called before accessing 'this' in the constructor of a derived class.");
pub const DERIVED_NEEDS_SUPER: Diagnostic = Diagnostic::new(2377, "Constructors for derived classes must contain a 'super' call.");
pub const GETTER_MUST_RETURN: Diagnostic = Diagnostic::new(2378, "A 'get' accessor must return a value.");
pub const ACCESSOR_TYPE_MISMATCH: Diagnostic = Diagnostic::new(2380, "The return type of a 'get' accessor must be assignable to its 'set' accessor type.");
pub const OVERLOAD_NOT_COMPATIBLE: Diagnostic = Diagnostic::new(2394, "This overload signature is not compatible with its implementation signature.");

// ============================================
// 2400-2449: Class Errors
// ============================================

pub const INCORRECTLY_EXTENDS: Diagnostic = Diagnostic::new(2415, "Class '{0}' incorrectly extends base class '{1}'.");
pub const STATIC_INCORRECTLY_EXTENDS: Diagnostic = Diagnostic::new(2417, "Class static side '{0}' incorrectly extends base class static side '{1}'.");
...
pub const ABSTRACT_INSTANTIATE: Diagnostic = Diagnostic::new(2511, "Cannot create an instance of an abstract class.");
pub const ABSTRACT_IN_NON_ABSTRACT: Diagnostic = Diagnostic::new(2512, "Abstract methods can only appear within an abstract class.");
pub const MISSING_ABSTRACT_MEMBER: Diagnostic = Diagnostic::new(2515, "Non-abstract class '{0}' does not implement inherited abstract member '{1}' from class '{2}'.");
...
pub const POSSIBLY_NULL_UNDEFINED: Diagnostic = Diagnostic::new(2533, "Object is possibly 'null' or 'undefined'.");
pub const INVALID_INDEX_TYPE: Diagnostic = Diagnostic::new(2538, "Type '{0}' cannot be used as an index type.");
pub const READONLY_INDEX: Diagnostic = Diagnostic::new(2542, "Index signature in type '{0}' only permits reading.");
pub const WRONG_ARG_COUNT: Diagnostic = Diagnostic::new(2554, "Expected {0} arguments, but got {1}.");
...
pub const IMPLICIT_ANY_VAR: Diagnostic = Diagnostic::new(7005, "Variable '{0}' implicitly has an 'any' type.");
pub const IMPLICIT_ANY_PARAM: Diagnostic = Diagnostic::new(7006, "Parameter '{0}' implicitly has an 'any' type.");
pub const IMPLICIT_ANY_MEMBER: Diagnostic = Diagnostic::new(7008, "Member '{0}' implicitly has an 'any' type.");
pub const IMPLICIT_ANY_RETURN: Diagnostic = Diagnostic::new(7010, "Function expression, which lacks return-type annotation, implicitly has an 'any' return type.");
pub const NO_INDEX_SIGNATURE: Diagnostic = Diagnostic::new(7017, "Element implicitly has an 'any' type because type '{0}' has no index signature.");
pub const IMPLICIT_ANY_SOME_LOCATIONS: Diagnostic = Diagnostic::new(7034, "Variable '{0}' implicitly has type 'any' in some locations where its type cannot be determined.");
pub const IMPLICIT_ANY_INDEX: Diagnostic = Diagnostic::new(7053, "Element implicitly has an 'any' type because expression of type '{0}' can't be used to index type '{1}'.");
